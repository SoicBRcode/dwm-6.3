...
static const char col_norm_border[] = "#2e3440";
...
/* commands */
// These two are commented out since I don't use dmenu
// static char dmenumon[2] = "0"; /* component of dmenucmd, manipulated in spawn() */
// static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *aplicationrunnercmd[] = { "krunner", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_r,      spawn,          {.v = aplicationrunnercmd } },
